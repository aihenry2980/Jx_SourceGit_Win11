(function () {
  ...
  const translations = {
    zh: {
      ...
      shotRecursiveAlt: "Jx SourceGit Win11 递归 submodule 更新弹窗截图",
      shotRecursiveCaption: "Recursive submodule update dialog / 递归更新弹窗",
    ...
    en: {
      ...
      shotRecursiveAlt: "Jx SourceGit Win11 recursive submodule update dialog screenshot",
      shotRecursiveCaption: "Recursive submodule update dialog",
